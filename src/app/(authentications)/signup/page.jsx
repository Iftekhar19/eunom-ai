      ...
      {credentials.isOtpGenerated ? (
        <section className=" rounded-2xl max-w-[471px] w-full bg-[#FFFFFF] login-box-shadow xs:p-[20px] md:p-[40px] flex flex-col gap-[36px]">
          ...
          <section className="flex flex-col items-center gap-3">
            <span className="text-[#718096] font-[500] text-xs">
              Don’t received the otp? 
              <span className="text-[#1A5CF4] font-[500] text-[14px] ">
                Resend OTP
              </span>
            </span>
            <Button
              ...
              icon={
                loading ? (
                  <Spinner size="md" color="default" className="text-white " />
                ) : (
                  ""
                )
              }
          ...
          <section className="flex flex-col gap-[24px]">
            ...
            <section className="flex flex-col gap-2">
              ...
              <LoginButton
                ...
                icon={<MsIcon />}
              />
              <LoginButton label={"Continue with Apple"} icon={<AppleIcon />} />
            </section>
          </section>
        </section>
      )}
