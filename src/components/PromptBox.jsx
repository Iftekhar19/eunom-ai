...
const PromptBox = ({setIsFirst,isFirst,setSideBarData}) => {
  ...
  return (
    <div className="w-full xs:py-2 md:py-6">
      <div
      ...
      >
        <PromptBoxIcon />
        <div style={{ display: "table" }} className="flex-1">
          <textarea
            name=""
            id=""
            onChange={(e) => {
            ...
            value={prompt}
            className="resize-none xs:py-1  sm:py-2 outline-none w-full text-[#00000066] font-[500] text-[14px]"
